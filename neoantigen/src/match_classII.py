...
def main():
	...
	if os.path.isfile(hlabind_file):
		#print(topspot_file)
		...
		df_uniq = df_uniq[['allele', 'seq_num', 'start', 'end', 'length', 'identity','peptide_x', 'Methods', 'Nmethods',
					   ...
					   'netmhciipan_el_core_peptide','netmhciipan_el_score','netmhciipan_el_percentile_rank','netmhciipan_el_adjusted_rank','Right_peptide']]
	...
	###filter 25mer column  include peptide column
		df_uniq = df_uniq[df_uniq.apply (lambda x: x.peptide in x.Right_peptide, axis=1)]
		...
		print("File is not exist:"+hlabind_file)
...
/home/ec2-user/anaconda3/bin/python /data/cyu/topspot/05252021/scripts/match_classII.py \
-i /data/cyu/topspot/05252021/output/summary/classII/BCD6_length21_iedb_mhcII.txt \
-r /data/cyu/topspot/05252021/input/pep_fasta/pep_loc.txt \
-o /data/cyu/topspot/05252021/output/summary/classII/
